  ...
  return (
    <FullHeightLayout>
      <BasicLayout>
        ...
        >
          <div className="text-base-content/60 relative rounded-full px-3 py-1 text-sm/6 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
          ...
          <p className="text-base-content/50 text-lg font-medium text-pretty sm:text-xl/8">
