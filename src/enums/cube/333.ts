...
export type OLLCategory = (typeof OLLCategory)[keyof typeof OLLCategory];

/** PLL 公式分類 */
export const PLLCategory = {
  /** 相鄰交換（Adj Swap） */
  ADJ_SWAP: "ADJ_SWAP",
  /** 對面交換（Opp Swap） */
  OPP_SWAP: "OPP_SWAP",
...
export type PLLCategory = (typeof PLLCategory)[keyof typeof PLLCategory];

/** F2L 公式分類 */
export const F2LCategory = {
...
export type F2LCategory = (typeof F2LCategory)[keyof typeof F2LCategory];
